...
- Monitor `.agents/tasks/`, planning docs, and recent commits/PR updates to maintain awareness of outstanding requests.
...
- Partner with Auditors and Coders to address recurring issues that documentation should solve.
